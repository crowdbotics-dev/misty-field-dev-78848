"""
Django settings for misty_field_dev_78848 project.
...
ROOT_URLCONF = 'misty_field_dev_78848.urls'
...
WSGI_APPLICATION = 'misty_field_dev_78848.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_field_dev_78848 API",
    "DESCRIPTION": "API documentation for misty_field_dev_78848 App",
    "VERSION": "v1",
}
